...
public class StatisticsPanel extends JPanel {
    ...
    private JPanel createControlPanel() {
        ...
        monthList.setFont(new Font("Segoe UI", Font.PLAIN, 12));
    ...
    public void updateStatistics() {
        ...
        if (selectedMonths.isEmpty()) {
            ...
            noSelection.setFont(new Font("Segoe UI", Font.ITALIC, 14));
    ...
    private void drawGroupedBarChart(Map<String, Map<String, Double>> data) {
